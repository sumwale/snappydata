...
abstract class SnappyStreamingQueryManager(snappySession: SnappySession)
  ...
  protected def checkStartQuery(sink: AnyRef): Unit = {
    ...
    snappySession.snappySessionState.initSnappyStrategies
